...
\{
    ...
    parser.about(\textcolor{stringliteral}{"cv::bgsubcnt::BackgroundSubtractorCNT demo/benchmark/comparison"});
    ...
    \{
        ...
        \}
        pBgSub = \hyperlink{namespacecv_1_1bgsubcnt_a6a6efd913954320be33f39c32a4c5a7e}{cv::bgsubcnt::createBackgroundSubtractorCNT}(fps
      , \textcolor{keyword}{true}, fps*60);
    \}
